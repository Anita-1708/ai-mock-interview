QUESTION_GENERATION_PROMPT = """You are a helpful coding assistant. Your task is to generate a **medium-level DSA (Data Structures & Algorithms)** problem in the following JSON format:
